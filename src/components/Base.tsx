...
export interface G2PlotChartProps<C extends Options> extends Pick<HTMLAttributes, PickedAttrs> {
  chart: any
...
const G2PlotChart = defineComponent<G2PlotChartProps<any>, G2PlotChartRawBindings<any>>({
  inheritAttrs: false,
  name: "G2PlotChart",
  mounted() {
  ...
  methods: {
    getChartConfig(): ChartOptions {
      const { chart, chartRef, ...restProps } = this.$attrs as Record< string,any>
